CREATE TABLE `tesla_data` (
	...
	`battery_level` TINYINT(3) UNSIGNED NULL DEFAULT NULL,
	...
	`inside_temp_f` FLOAT(10,7) AS (((`inside_temp` * (9 / 5)) + 32)) VIRTUAL,
	`outside_temp` FLOAT(10,7) NULL DEFAULT NULL,
	`outside_temp_f` FLOAT(10,7) AS (((`outside_temp` * (9 / 5)) + 32)) VIRTUAL,
	`climate_flags` TINYINT(3) UNSIGNED NOT NULL,
	`speed` TINYINT(3) UNSIGNED NULL DEFAULT NULL,
